void auto3()
{
		...
		wait1Msec(500);
		rollIntake(-80); //Pick up a ground cone
		desiredFourTicks = 1139; //Move chainbar to ground position
		rollIntake(0);
		moveMogo(0);
		desiredFourTicks = 480; //move chainbar to up position after picking up the ground cone
